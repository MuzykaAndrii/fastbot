...
from app.bot.vocabulary import services as vocabulary_services  # emulation of api request to bot service
...
async def send_notifications(auth: AuthorizationSchema):
    ...
    await vocabulary_services.send_notifications(active_vocabularies)
